<div class="content-header">
      ...
      <div class="portlet">
        ...
        <div class="portlet-content">
          <form action="<?= base_url() ?>prof/signalerProbleme" method="post" class="signaler-probleme"  enctype="multipart/form-data"> 
            ...
            <div class="col-sm-12 no-padding">
              <div class="fileupload fileupload-new" data-provides="fileupload">
                ...
                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"> <img src="https://www.placehold.it/200x150/82e0fb/AAAAAA&amp;text=Pas+d'image" alt="Placeholder" /> </div>
