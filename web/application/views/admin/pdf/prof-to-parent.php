...
<body>
	...
	<h3 style="text-align: center;margin-bottom: 60px;">Historique des messages des professeurs à <?php echo $title; ?></h3> 
 	<table>	
		<?php foreach ($Messages as $key => $Message):?>
		 	<tr>
				<td style="border-bottom: 1px dotted #eee"><br><br>
				<strong style="margin-top: 10px;">Date: </strong><?= date("d/m/Y", $Message->time) ?><br>
				<strong>Matière: </strong><?= $Message->matiere ?><br>
...
<?php  
	...
	$pdf->Output('Envois-des-professeurs-a-'.$title.'.pdf', 'D');
