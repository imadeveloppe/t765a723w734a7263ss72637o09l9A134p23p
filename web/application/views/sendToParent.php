<div class="content-header">
  <h2 class="content-header-title">Communiquer avec les parents</h2>
  <ol class="breadcrumb">
    <li><a href="./">Home</a></li>
    <li class="active">Communiquer avec les parents</li>
  </ol>
</div>
<!-- /.content-header -->
<div class="portlet">
  ...
  <div class="portlet-content"> 
    <form action="<?= base_url() ?>Administration/SendMessageToParent" method="post" class="col-md-12 no-padding" enctype="multipart/form-data" id="sendtoparent" style="opacity: 0"> 
    <div class="loader"></div>
          ...
          <div class="radio" style="padding: 0;">
            <label>
              <input type="radio" name="message_type" value="discipline" checked> <span style="position: relative;top: -4px;">
                Administration (aux parent et élève)
              </span>
            </label>
          </div>
          <div class="radio" style="padding: 0;">
            <label>
              <input type="radio" name="message_type" value="actualite"> <span style="position: relative;top: -4px;">
                Événements (aux parent et élève)
              </span>
            </label>
          </div>
          <div class="radio" style="padding: 0;">
            <label>
              <input type="radio" name="message_type" value="parent"> <span style="position: relative;top: -4px;">
                Administration (juste au parent)
              </span>
            </label>
          </div>
        </div>  
      ...
      <div class="row"> 
        <div class="col-sm-4" style="margin: 10px 0 30px;">
            ...
            <div id="dp-ex-3" class="input-group date col-sm-12" data-auto-close="true" data-date="" data-date-format="dd/mm/yyyy" data-date-autoclose="true">
...
$(document).ready(function () {   
  ...
  $('#sendtoparent').css('opacity', 1)

  $('body').on('click','#confirmation .confirm',function() { 
    $('.loader').fadeIn();
    setTimeout(function () {
      $('form#sendtoparent')[0].submit();
    },1000)
  }) 
  $('body').on('click','#sendtoparent #submitbtn',function() { 
